    ...
    <div class="row">
        <div class="col-md-12 d-flex flex-column">
            ...
            <p class="lead text-center">
                <a href="<?php echo get_theme_mod( 'cta_url', '/blog'); ?>"
                    class="btn btn-lg btn-primary font-weight-"><?php echo get_theme_mod( 'cta_text', 'Click here'); ?></a>
            </p>
        </div>
    </div>
</main>
...
.showcase {
    ...
    <?php if(get_theme_mod('showcase_image') !=''): ?> <?php $showcaseImage=esc_url(get_theme_mod( 'showcase_image')); ?>
    <?php endif; ?>
    background: url(<?php echo $showcaseImage; ?>) !important;
}
</style>
